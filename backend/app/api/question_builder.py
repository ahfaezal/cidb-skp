...
- Format CIDB Kata Kerja / Verb hanya terpakai untuk soalan objektif yang mempunyai skillCategory "Prosedur" sahaja.
- Untuk soalan "Prosedur", pilihan jawapan mesti bermula dengan Kata Kerja / Verb yang jelas dan aktif kerana soalan prosedur menilai langkah, tindakan, kaedah kerja atau pematuhan proses. Jika bahasa ialah English, gunakan verb seperti Identify, Select, Use, Check, Apply, Maintain, Inspect, Position, Label, Plan, Increase, Minimize atau Verify. Jika bahasa ialah Bahasa Melayu, gunakan kata kerja seperti Kenal pasti, Pilih, Gunakan, Semak, Laksanakan, Kekalkan, Periksa, Letakkan, Labelkan, Rancang, Tingkatkan, Kurangkan atau Sahkan.
- Untuk soalan "Fakta / Teori" dan "Sikap / Keselamatan / Alam Sekitar", jangan paksa pilihan jawapan bermula dengan Kata Kerja / Verb. Pilihan jawapan perlu natural mengikut konteks, contohnya istilah, standard, prinsip, konsep, fakta, tingkah laku, amalan keselamatan, kesan alam sekitar atau respons kerja yang tepat.
...
- Untuk objectiveFormat "Soalan Satu (1) Pilihan", susun pilihan jawapan A-D daripada teks paling pendek kepada paling panjang. Label A-D mesti ikut susunan baharu dan correctAnswer mesti merujuk label baharu yang betul. Jika skillCategory ialah "Prosedur", setiap pilihan A-D mesti bermula dengan Kata Kerja / Verb. Jika skillCategory bukan "Prosedur", jangan tambah kata kerja secara paksa.
- Untuk objectiveFormat "Soalan Aneka Gabungan", bina 4 item pernyataan dalam field combinationItems menggunakan label I, II, III dan IV. Susun item I-IV daripada teks paling pendek kepada paling panjang. Jika skillCategory ialah "Prosedur", setiap item I-IV mesti bermula dengan Kata Kerja / Verb. Jika skillCategory bukan "Prosedur", item I-IV boleh menggunakan istilah, konsep, fakta, prinsip atau pernyataan yang natural. Field options wajib menggunakan kombinasi tetap A-D. Jika bahasa ialah English, gunakan "and"; jika bahasa ialah Bahasa Melayu, gunakan "dan". Jangan ubah kedudukan pilihan A-D ini.
